 ...
 */
export class WorkerPool extends RemoteAwareMixin(ListenerAwareMixin()) {
    /**
     *
     ...
     */
    postMessage(data, transferable = undefined) {
        return this.postRemoteMessage(data, transferable);
    }
